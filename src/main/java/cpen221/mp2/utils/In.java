...
public final class In {
   ...
   /**
    ...
    public static void main(String[] args) {
        In in;
        String urlName = "http://www.textfiles.com/food/baklava.des";
        ...
        // read one line at a time from file local filesystem
        System.out.println("readLine() from local filesystem");
        System.out.println("---------------------------------------------------------------------------");
        try {
            in = new In(".data/tests/6502bugs.txt");
            while (!in.isEmpty()) {
                String s = in.readLine();
                System.out.println(s);
            }
